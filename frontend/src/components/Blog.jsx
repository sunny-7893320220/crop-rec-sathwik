...
const getListItem = (topic, href, byUser, amountComments, date, imgName) => (
    <li className='w-[460px] h-[514px] bg-[#2D442F]'>
        <a href={href}>
            <img src={`/images/from_the_blog/${imgName}.svg`} alt="" width={460} height={364} />
            <div className='relative flex flex-col gap-5 p-5'>
                <div className='flex gap-5'>
                    <div className='flex gap-[7px]'>
                        <img src={`/images/from_the_blog/user.svg`} alt="" width={20} height={10} />
                        <span className='text-[14px]'>by {byUser}</span>
                    </div>
                    <div className='flex gap-[7px]'>
                        <img src={`/images/from_the_blog/comment.svg`} alt="" width={20} height={10} />
