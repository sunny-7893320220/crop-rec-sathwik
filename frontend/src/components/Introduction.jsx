    ...
    return (
        <div className="relative w-full flex gap-20 pt-[100px] pb-[159px]">
            ...
            <div className='relative h-fit'>
                <img src="/images/our_introduction/1.svg" alt="" width={564} height={651}/>
                ...
                <div className='absolute -bottom-[59px] translate-x-1/2 right-1/2 w-[428px] h-[140px] rounded-[10px] flex justify-evenly items-center bg-[#6D8C54]'>
                    <img src="/images/our_introduction/icon1.svg" alt="" width={76} height={70}/>
            ...
            <div className="flex flex-col gap-[55px] pt-[19px]">
                ...
                <div className="flex flex-col gap-5">
                    <ul className='flex flex-col gap-5'>
                        <li className='flex gap-5'><img src={'/images/our_introduction/icon2.svg'} alt="" width={20} height={21}/>Organic food contains more vitamins</li>
                        <li className='flex gap-5'><img src={'/images/our_introduction/icon2.svg'} alt="" width={20} height={21}/>Eat organic because supply meets demand</li>
                        <li className='flex gap-5'><img src={'/images/our_introduction/icon2.svg'} alt="" width={20} height={21}/>Organic food is never irradiated</li>
                    </ul>
                </div>
            </div>
        </div>
