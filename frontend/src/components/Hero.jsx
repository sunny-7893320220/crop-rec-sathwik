        ...
        <section className="bg-[url(/images/hero/1.svg)] h-[954px] pt-[290px] -mt-[110px]">
            <div className="w-[730px] h-[430px]">
                <div className="relative mb-[15px]">
                    <img src="/images/hero/underline1.svg" alt="" width={215} height={30} className="absolute -bottom-1"/>
                ...
                <div className="flex flex-col gap-[30px]">
                    <div className="flex flex-col gap-[10px]">
                        <div>
                            <div className="relative w-[639px] h-[109px]">
                                <img src="/images/hero/icon1.svg" alt="" width={75} height={62} className="absolute -top-[21px] right-[3px]"/>
                    ...
                    <a href="" className="w-fit rounded-[20px] px-[50px] py-[25px] uppercase text-black bg-[#F7C35F]">Discover More</a>
                </div>
            </div>
        </section>
    );
